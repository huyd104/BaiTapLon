...
<head>
  ...
  <script src="https://kit.fontawesome.com/511b6f8ac2.js" crossorigin="anonymous"></script>
...
<body>
  ...
  <div class="container ">
    <div id="main">
      ...
      <div class="text">
        <i>
          <h1 class="">Tìm nơi dừng chân hoàn hảo cùng Hahalolo!</h1>
        </i>
        ...
        <div class="col-12 col-md-6 col-lg-3 ">
          <div class="card">
            ...
            <div class="card-body ">
              ...
              <a href="https://www.google.com/maps" class="card-link">172 - 180 North Genesee StrUtica NY 13502 US</a>
        ...
        <div class="col-12 col-md-6 col-lg-3 ">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <i class="fas fa-map-marker-alt"></i>
              <a href="https://www.google.com/maps" class="card-link">6006 Fair Lakes Road East Syracuse NY 13057 US</a>
              <p class="card-text0">Giá mỗi đêm</p>
        ...
        <div class="col-12 col-md-6 col-lg-3 ">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <i class="fas fa-map-marker-alt"></i>
              <a href="https://www.google.com/maps" class="card-link">22 to 36 Nguyen Hue Blvd Ho Chi Minh City 70000 VN
              </a>
              <p class="card-text0">Giá mỗi đêm</p>
        ...
        <div class="col-12 col-md-6 col-lg-3 ">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <i class="fas fa-map-marker-alt"></i>
              <a href="https://www.google.com/maps" class="card-link">8A Nguyen Binh Khiem St Ho Chi Minh City 70000 VN
              </a>
              <p class="card-text0">Giá mỗi đêm</p>
              <p class="card-text">3.212.563 đ</p>
            </div>
        ...
        <div class="col-12 col-md-6 col-lg-3">
          <div class="card">
            ...
            <div class="card-body">
              <h5>REX HOTEL</h5>
              <i class="fas fa-map-marker-alt"></i>
              <a href="https://www.google.com/maps" class="card-link">141 Nguyen Hue Boulevard DHO CHI MINH CITY 70000
                VN
              </a>
              <p class="card-text0">Giá mỗi đêm</p>
              <p class="card-text">3.212.563 đ</p>
        ...
        <div class="col-12 col-md-6 col-lg-3 ">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <i class="fas fa-map-marker-alt"></i>
              <a href="https://www.google.com/maps" class="card-link">8A Nguyen Binh Khiem St Ho Chi Minh City 70000
                VN</a>
              <p class="card-text0">Giá mỗi đêm</p>
              <p class="card-text">3.212.563 đ</p>
            </div>
        ...
        <div class="col-12 col-md-6 col-lg-3 ">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <i class="fas fa-map-marker-alt"></i>
              <a href="https://www.google.com/maps" class="card-link">144 Nguyen Van Troi StreetHo Chi Minh City 70000
                VN</a>
              <p class="card-text0">Giá mỗi đêm</p>
              <p class="card-text">3.212.563 đ</p>
            </div>
        ...
        <div class="col-12 col-md-6 col-lg-3 ">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <i class="fas fa-map-marker-alt"></i>
              <a href="https://www.google.com/maps" class="card-link">192 Nam Ky Khoi Nghia Ho Chi Minh City 700000
                VN</a>
              <p class="card-text0">Giá mỗi đêm</p>
              <p class="card-text">3.212.563 đ</p>
            </div>
        ...
        <div class="col-12 col-md-6 col-lg-3">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <i class="fas fa-map-marker-alt"></i>
              <a href="https://www.google.com/maps" class="card-link">2A 4A Ton Duc Thang Street Ho Chi Minh 700000 VN
              </a>
        ...
        <div class="col-12 col-md-6 col-lg-3">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <i class="fas fa-map-marker-alt"></i>
              <a href="https://www.google.com/maps" class="card-link">22 Nguyen Hue Boulevard Ho Chi Minh City 70000 VN
              </a>
              <p class="card-text0">Giá mỗi đêm</p>
              <p class="card-text">3.212.563 đ</p>
            </div>
        ...
        <div class="col-12 col-md-6 col-lg-3 ">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <i class="fas fa-map-marker-alt"></i>
              <a href="https://www.google.com/maps" class="card-link">67 Le Loi Boulevard Ho Chi Minh City VN
              </a>
              <p class="card-text0">Giá mỗi đêm</p>
              <p class="card-text">3.212.563 đ</p>
            </div>
        ...
        <div class="col-12 col-md-6 col-lg-3">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <i class="fas fa-map-marker-alt"></i>
              <a href="https://www.google.com/maps" class="card-link">CORNER NGUYEN DU ST. HAIHO CHI MINH CITY VN
              </a>
              <p class="card-text0">Giá mỗi đêm</p>
              <p class="card-text">3.212.563 đ</p>
            </div>
    ...
    <div class="container ">
      <div class="row">
        ...
        <div class=" col-md-6">
          ...
          <p class=" lead fs-6">
            Trải nghiệm vẻ đẹp bình yên mang đến những phút giây thật sự thư giãn dành riêng cho bạn trong tiết trời
            sang thu đang dần trải dài trên nền cát trắng dưới bầu trời xanh ngát tại Amiana Resort Nha Trang. Sẽ là
            tuần trăng mật thật lãng mạn hay trải nghiệm kỳ nghỉ đáng nhớ trên bãi biển hoặc tạo nên những phút giây sum
            họp bên gia đình, bạn bè với Ưu...
            <a href="">Xem thêm</a>
          </p>
          ...
          <div class="card1 g-3">
            ...
            <div class="row1 ms-4 lh-1">
              ...
              <p class="lead fs-6 lh-1">
                Tổng Hợp Khuyến Mãi Các Khách Sạn Tại Đà Nẵng Nhân Dịp Cuối Năm 2021 1. KHUYẾN MẠI CUỐI NĂM VỚI NHIỀU ƯU
                ĐÃI TẠI CICILIA ĐÀ NẴNG!...
                <a href="">Xem thêm</a>
              </p>
            </div>
          </div>
